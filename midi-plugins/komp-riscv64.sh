...
cc -shared -Wl,-soname,midi-fluidsynth.so -o midi-fluidsynth.so -fpic -fvisibility=hidden -O2 -Wall -march=rv64gc midi-fluidsynth.c -I`pwd`/include -lfluidsynth -L`pwd`/lib/riscv64
