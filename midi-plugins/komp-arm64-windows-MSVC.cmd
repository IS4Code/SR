...
link /NOLOGO /DLL /OUT:midi2-windows.dll midi2-windows.obj /DEF:midi2.def /MACHINE:ARM64 winmm.lib uuid.lib
...
cd ..
cd nuked_opl3
cl /nologo /c /O2 /W3 /MD /DDISABLE_UNUSED_FUNCTIONS opl3.c
cd ../..
link /NOLOGO /DLL /OUT:adlib-dosbox_opl.dll *.obj src/*.obj src/dosbox_opl/*.obj src/nuked_opl3/*.obj /DEF:..\midi.def /MACHINE:ARM64 %SPEEXDSP_LINK% /LIBPATH:..\lib\arm64
...
cd ../../../..
link /NOLOGO /DLL /OUT:mt32-munt.dll *.obj src/*.obj src/munt-2.8/mt32emu/*.obj src/munt-2.8/mt32emu/sha1/*.obj /DEF:..\midi.def /MACHINE:ARM64 %SPEEXDSP_LINK% /LIBPATH:..\lib\arm64
...
cd pcem_emu8k
cl /nologo /c /O2 /W3 /wd4244 /MD sound_emu8k.c
cd ../..
link /NOLOGO /DLL /OUT:awe32-emu8k.dll *.obj src/*.obj src/pcem_emu8k/*.obj /DEF:..\midi.def /MACHINE:ARM64 %SPEEXDSP_LINK% /LIBPATH:..\lib\arm64
