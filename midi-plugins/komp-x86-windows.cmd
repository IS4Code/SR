...
g++ -c -m32 -O2 -Wall -fno-exceptions emu_mt32.cpp -I./munt-2.8
cd munt-2.8/mt32emu
...
cd ../../../..
g++ -s -shared -static-libgcc -static-libstdc++ -o mt32-munt.dll -m32 *.o src/*.o src/munt-2.8/mt32emu/*.o src/munt-2.8/mt32emu/sha1/*.o ../midi.def -lm %SPEEXDSP_LINK% -L../lib/x86
