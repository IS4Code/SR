...
cc -bundle -o midi-fluidsynth.so -fpic -fvisibility=hidden -arch x86_64 -O2 -Wall midi-fluidsynth.c -I`pwd`/include -lfluidsynth -L`pwd`/lib/x64
cc -bundle -o midi-adlmidi.so -fpic -fvisibility=hidden -arch x86_64 -O2 -Wall $SPEEXDSP_COMPILE midi-adlmidi.c -I`pwd`/include -lADLMIDI $SPEEXDSP_LINK -L`pwd`/lib/x64
...
c++ -c -fpic -fvisibility=hidden -arch x86_64 -O2 -Wall -fno-exceptions emu_mt32.cpp -I$CURDIR/src/munt-2.8
cd munt-2.8/mt32emu
c++ -c -fpic -fvisibility=hidden -arch x86_64 -O3 -Wall -fno-exceptions -DMT32EMU_WITH_STD_SNPRINTF *.cpp
...
cd ../../../..
cc -bundle -o mt32-munt.so -arch x86_64 *.o src/*.o src/munt-2.8/mt32emu/*.o src/munt-2.8/mt32emu/sha1/*.o -lm $SPEEXDSP_LINK -lstdc++ -L../lib/x64
