...
link /NOLOGO /DLL /OUT:midi-fluidsynth.dll midi-fluidsynth.obj /DEF:midi.def /MACHINE:X86 fluidsynth.lib /LIBPATH:.\lib\x86
...
cd ../../../..
link /NOLOGO /DLL /OUT:mt32-munt.dll *.obj src/*.obj src/munt-2.8/mt32emu/*.obj src/munt-2.8/mt32emu/sha1/*.obj /DEF:..\midi.def /MACHINE:X86 %SPEEXDSP_LINK% /LIBPATH:..\lib\x86
