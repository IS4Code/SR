...
link /NOLOGO /DLL /OUT:midi-wildmidi.dll midi-wildmidi.obj /DEF:midi.def /MACHINE:X64 libWildMidi.lib %SPEEXDSP_LINK% /LIBPATH:.\lib\x64
cl /nologo /c /O2 /W3 /MD midi-bassmidi.c /I.\include
link /NOLOGO /DLL /OUT:midi-bassmidi.dll midi-bassmidi.obj /DEF:midi.def /MACHINE:X64 bassmidi.lib bass.lib /LIBPATH:.\lib\x64
cl /nologo /c /O2 /W3 /MD midi-fluidsynth.c /I.\include
link /NOLOGO /DLL /OUT:midi-fluidsynth.dll midi-fluidsynth.obj /DEF:midi.def /MACHINE:X64 fluidsynth.lib /LIBPATH:.\lib\x64
...
cd ../..
link /NOLOGO /DLL /OUT:adlib-dosbox_opl.dll *.obj src/*.obj src/dosbox_opl/*.obj src/nuked_opl3/*.obj /DEF:..\midi.def /MACHINE:X64 %SPEEXDSP_LINK% /LIBPATH:..\lib\x64
...
cd ../..
link /NOLOGO /DLL /OUT:awe32-emu8k.dll *.obj src/*.obj src/pcem_emu8k/*.obj /DEF:..\midi.def /MACHINE:X64 %SPEEXDSP_LINK% /LIBPATH:..\lib\x64
