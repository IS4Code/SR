...
CURDIR=`pwd`
cc -c -fpic -fvisibility=hidden -m64 -O2 -Wall mpsmusic-driver.c -I$CURDIR/include -I../
cd src
cc -c -fpic -fvisibility=hidden -m64 -O3 -Wall -Wno-maybe-uninitialized -DDRIVER=ADLIB $SPEEXDSP_COMPILE emu_x86.c -I$CURDIR/include -I../../include
c++ -c -fpic -fvisibility=hidden -m64 -O2 -Wall -fno-exceptions emu_opl2.cpp
cd dosbox_opl
c++ -c -fpic -fvisibility=hidden -m64 -O3 -Wall -fno-exceptions opl.cpp
cd ..
cd nuked_opl3
cc -c -fpic -fvisibility=hidden -m64 -O3 -Wall -DDISABLE_UNUSED_FUNCTIONS opl3.c
cd ../..
cc -shared -Wl,-soname,adlib-dosbox_opl.so -o adlib-dosbox_opl.so -m64 *.o src/*.o src/dosbox_opl/*.o src/nuked_opl3/*.o -lm $SPEEXDSP_LINK -L../lib/x64
...
cc -c -fpic -fvisibility=hidden -m64 -O2 -Wall emu_awe32.c
cd pcem_emu8k
cc -c -fpic -fvisibility=hidden -m64 -O3 -Wall sound_emu8k.c
cd ../..
cc -shared -Wl,-soname,awe32-emu8k.so -o awe32-emu8k.so -m64 *.o src/*.o src/pcem_emu8k/*.o -lm $SPEEXDSP_LINK -L../lib/x64
