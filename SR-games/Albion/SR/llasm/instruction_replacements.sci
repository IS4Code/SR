...
loc_25517,7,;mov dword [ebp-8], 1|add tmpadr, ebp, -8|mov tmp1, 1|store tmp1, tmpadr, 4|;cmp dword [eax+12], 0x109|add tmpadr, eax, 12|load tmp1, tmpadr, 1|sub tmp1, tmp1, 0x109|ctcallz tmp1, loc_25517_qs|tcall loc_25517_pre2|endp|proc loc_25517_qs ; F9 quicksave, independent of Game_ScreenshotEnabled|call Game_QuickSave_KeyTriggered|tcall loc_25517_pre2|endp|proc loc_25517_pre2|;cmp dword [Game_ScreenshotEnabled], 0|load tmp1, Game_ScreenshotEnabled, 4|;je loc_25517_end|ctcallz tmp1, loc_25517_2|tcall loc_25517_1|endp|proc loc_25517_1|;only take the shortcut on plain F8|add tmpadr, eax, 8|load tmp2, tmpadr, 1|and tmp2, tmp2, 32|ctcallnz tmp2, loc_25517_2|tcall loc_25517_3|endp|proc loc_25517_3|;cmp dword [eax+12], 0x108|add tmpadr, eax, 12|load tmp1, tmpadr, 1|sub tmp1, tmp1, 0x108|;je loc_255EF|ctcallz tmp1, loc_255EF|tcall loc_25517_2|endp|;loc_25517_end:|proc loc_25517_2 ; screenshot dialog on plain F8 key
...
loc_17D10,1,;push ebx ; Draw_2D_map|load tmp1, Game_SyntheticQuadrantPass, 4|ctcallnz tmp1, loc_17D10_inner|tcall loc_17D10_outer|endp|proc loc_17D10_inner|PUSH ebx|tcall loc_17D11|endp|proc loc_17D10_outer|POP tmpadr|store tmpadr, Game_Enh2D_TrueCallerAddr, 4|PUSH loc_17D10_vanilla|tcall Game_Enh2D_BeginFrame_proc|endp|proc loc_17D10_vanilla|;pass 1|PUSH loc_17D10_afterVanilla|PUSH ebx|tcall loc_17D11|endp|proc loc_17D10_afterVanilla|PUSH loc_17D10_loop|tcall Game_Enh2D_BeginQuadrants_proc|endp|proc loc_17D10_loop|;capture pass, grid size decided by Game_Enh2D_BeginQuadrants|PUSH loc_17D10_afterCapture|PUSH ebx|tcall loc_17D11|endp|proc loc_17D10_afterCapture|call Game_Enh2D_NextTile|mov eax, tmp0|mov tmpcnd, eax|ctcallnz tmpcnd, loc_17D10_loop|tcall loc_17D10_resync|endp|proc loc_17D10_resync|;final pass|PUSH loc_17D10_fin|PUSH ebx|tcall loc_17D11|endp|proc loc_17D10_fin|;clear the flags, write the composite back into Scroll_2D.Base_OPM|PUSH loc_17D10_specitems|tcall Game_Enh2D_Finish_proc|endp|proc loc_17D10_specitems|;draw the overlays|PUSH loc_17D10_present|tcall loc_1FDB1|endp|proc loc_17D10_present|;put through display path|PUSH loc_17D10_done|tcall loc_1847B|endp|proc loc_17D10_done|load tmpadr, Game_Enh2D_TrueCallerAddr, 4|tcall tmpadr|endp|proc loc_17D11

loc_191E4,1,;push ebx ; skip camera movement on Game_SyntheticQuadrantPass|load tmp1, Game_SyntheticQuadrantPass, 4|ctcallnz tmp1, loc_191E4_skip|tcall loc_191E4_cont|endp|proc loc_191E4_skip|;early return|POP tmp2|tcall tmp2|endp|proc loc_191E4_cont|PUSH ebx|tcall loc_191E5|endp|proc loc_191E5

loc_1847B,1,;push ebx ; suppress Draw_2D_scroll_buffer on Game_Enh2D_SuppressScrollDraw|load tmp1, Game_Enh2D_SuppressScrollDraw, 4|ctcallnz tmp1, loc_1847B_skip|tcall loc_1847B_cont|endp|proc loc_1847B_skip|;early return|POP tmp2|tcall tmp2|endp|proc loc_1847B_cont|;continue unmodified|PUSH ebx|tcall loc_1847C|endp|proc loc_1847C
loc_1FDB1,5,;push dword 0x2c ; suppress overlay drawing|load tmp1, Game_Enh2D_SuppressScrollDraw, 4|ctcallnz tmp1, loc_1FDB1_skip|tcall loc_1FDB1_cont|endp|proc loc_1FDB1_skip|;early return|POP tmp2|tcall tmp2|endp|proc loc_1FDB1_cont|PUSH 0x2c|tcall loc_1FDB1_after|endp|proc loc_1FDB1_after
loc_6D38B,4,;sub dx, [edi+0x8] ; albion#0bb2181 (vertical)
loc_6D40E,4,;sub dx, [edi+0x6] ; albion#0bb2181 (horizontal)
loc_14232,14,;mov dword [ebp-0x10], 0x20|;mov dword [ebp-0xc], 0x30 ; view-space party box, big guy (zoom-scaled, was hardcoded half)|mov tmp1, 1|call Game_Enh2D_PartyBox tmp1|load tmp1, Game_Enh2D_PartyBoxW, 4|add tmpadr, ebp, -16|store tmp1, tmpadr, 4|load tmp1, Game_Enh2D_PartyBoxH, 4|add tmpadr, ebp, -12|store tmp1, tmpadr, 4
loc_14242,14,;mov dword [ebp-0x10], 0x10|;mov dword [ebp-0xc], 0x20 ; view-space party box, small guy (zoom-scaled, was hardcoded half)|mov tmp1, 0|call Game_Enh2D_PartyBox tmp1|load tmp1, Game_Enh2D_PartyBoxW, 4|add tmpadr, ebp, -16|store tmp1, tmpadr, 4|load tmp1, Game_Enh2D_PartyBoxH, 4|add tmpadr, ebp, -12|store tmp1, tmpadr, 4|tcall loc_14250|endp
loc_140A8,90,;mov ax, [loc_14A356] ; composite-space tile selection arithmetic|call Game_Enh2D_SelectArea|load tmp1, Game_Enh2D_SelX, 4|add tmpadr, ebp, -16|store tmp1, tmpadr, 4|load tmp1, Game_Enh2D_SelY, 4|add tmpadr, ebp, -12|store tmp1, tmpadr, 4|load tmp1, Game_Enh2D_SelW, 4|add tmpadr, ebp, -8|store tmp1, tmpadr, 4|load tmp1, Game_Enh2D_SelH, 4|add tmpadr, ebp, -4|store tmp1, tmpadr, 4
loc_13F1C,5,;push dword 0x28 ; Display_M2_selection - X in eax, Y in edx, untouched here|load tmp1, Game_Enh2D_CompositeActive, 4|ctcallnz tmp1, Game_Enh2D_SelectDraw_proc|tcall loc_13F1C_vanilla|endp|proc loc_13F1C_vanilla|PUSH 0x28
