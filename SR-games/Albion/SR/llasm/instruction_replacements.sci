...
loc_25517,7,;mov dword [ebp-8], 1|add tmpadr, ebp, -8|mov tmp1, 1|store tmp1, tmpadr, 4|;cmp dword [Game_ScreenshotEnabled], 0|load tmp1, Game_ScreenshotEnabled, 4|;je loc_25517_end|ctcallz tmp1, loc_25517_2|tcall loc_25517_1|endp|proc loc_25517_1|;only take the shortcut on plain F8|add tmpadr, eax, 8|load tmp2, tmpadr, 1|and tmp2, tmp2, 32|ctcallnz tmp2, loc_25517_2|tcall loc_25517_3|endp|proc loc_25517_3|;cmp dword [eax+12], 0x108|add tmpadr, eax, 12|load tmp1, tmpadr, 1|sub tmp1, tmp1, 0x108|;je loc_255EF|ctcallz tmp1, loc_255EF|tcall loc_25517_2|endp|;loc_25517_end:|proc loc_25517_2 ; screenshot dialog on plain F8 key
